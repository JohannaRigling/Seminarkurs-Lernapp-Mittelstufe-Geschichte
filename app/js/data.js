    ...
    klasse8: [
        {
            ...
            description: 'Übersicht der Themen für Klasse 8: Französische Revolution, Industrialisierung, Imperialismus',
            category: 'overview',
            topics: ['französische-revolution', 'industrialisierung', 'imperialismus'],
            type: 'document'
        },
        {
            id: 'k8-img-2',
            filename: 'IMG_2192.jpeg',
            title: 'Glossar Klasse 8 - Teil 1',
            description: 'Fachbegriffe: Absolutismus, Aufklärung, Bürgertum, Gewaltenteilung',
            category: 'glossar',
            topics: ['französische-revolution', 'absolutismus'],
            type: 'reference'
        },
        {
            id: 'k8-img-3',
            filename: 'IMG_2193.jpeg',
            title: 'Glossar Klasse 8 - Teil 2',
            description: 'Fachbegriffe: Industrialisierung, Kapitalismus, Proletariat, Soziale Frage',
            category: 'glossar',
            topics: ['industrialisierung', 'soziale-frage'],
            type: 'reference'
        },
        {
            id: 'k8-img-4',
            filename: 'IMG_2209.jpeg',
            title: 'Operatoren AFB I - Reproduktion',
            description: 'Operatoren: Nennen, Beschreiben, Zusammenfassen, Wiedergeben',
            category: 'methoden',
            topics: ['operatoren'],
            type: 'method'
        },
        {
            id: 'k8-img-5',
            filename: 'IMG_2212.jpeg',
            title: 'Die Französische Revolution - Zeitleiste',
            description: 'Chronologische Übersicht der wichtigsten Ereignisse 1789-1799',
            category: 'zeitleiste',
            topics: ['französische-revolution'],
            type: 'timeline'
        },
        {
            id: 'k8-img-6',
            filename: 'IMG_2213.jpeg',
            title: 'Ständegesellschaft vor 1789',
            description: 'Darstellung der drei Stände im Ancien Régime',
            category: 'grafik',
            topics: ['französische-revolution', 'absolutismus'],
            type: 'infographic'
        },
        {
            id: 'k8-img-7',
            filename: 'IMG_2214.jpeg',
            title: 'Industrialisierung - Technische Erfindungen',
            description: 'Dampfmaschine, Spinnmaschine, Eisenbahn: Die wichtigsten Innovationen',
            category: 'grafik',
            topics: ['industrialisierung'],
            type: 'infographic'
        },
        {
            id: 'k8-img-8',
            filename: 'IMG_2215.jpeg',
            title: 'Soziale Frage - Arbeitsbedingungen',
            description: 'Leben und Arbeiten in der Fabrik, Kinderarbeit, Wohnverhältnisse',
            category: 'quelle',
            topics: ['industrialisierung', 'soziale-frage'],
            type: 'source'
        },
        {
            id: 'k8-img-9',
            filename: 'IMG_2216.jpeg',
            title: 'Imperialismus - Kolonialreiche',
            description: 'Karte der europäischen Kolonien in Afrika und Asien um 1914',
            category: 'karte',
            topics: ['imperialismus'],
            type: 'map'
        },
        {
            id: 'k8-img-10',
            filename: 'IMG_2217.jpeg',
            title: 'Erster Weltkrieg - Bündnissysteme',
            description: 'Dreibund und Triple Entente vor 1914',
            category: 'karte',
            topics: ['erster-weltkrieg'],
            type: 'map'
        },
        {
            id: 'k8-img-11',
            filename: 'IMG_2218.jpeg',
            title: 'Weimarer Republik - Verfassungsschema',
            description: 'Aufbau und Struktur der Weimarer Verfassung',
            category: 'grafik',
            topics: ['weimarer-republik'],
            type: 'infographic'
        },
        {
            id: 'k8-img-12',
            filename: 'IMG_2219.jpeg',
            title: 'Operatoren AFB II - Reorganisation',
            description: 'Operatoren: Analysieren, Erklären, Vergleichen, Einordnen',
            category: 'methoden',
            topics: ['operatoren'],
            type: 'method'
        },
        {
            id: 'k8-img-13',
            filename: 'IMG_2220.jpeg',
            title: 'Operatoren AFB III - Reflexion',
            description: 'Operatoren: Beurteilen, Bewerten, Erörtern, Stellung nehmen',
            category: 'methoden',
            topics: ['operatoren'],
            type: 'method'
        }
    ...
    klasse9: [
        {
            ...
            title: 'Inhaltsverzeichnis Klasse 9',
            description: 'Übersicht: Nationalsozialismus, Zweiter Weltkrieg, BRD/DDR, Kalter Krieg',
            category: 'overview',
            topics: ['nationalsozialismus', 'zweiter-weltkrieg', 'brd-ddr'],
            type: 'document'
        },
        {
            id: 'k9-img-2',
            filename: 'IMG_2195.jpeg',
            title: 'Glossar Klasse 9 - NS-Zeit',
            description: 'Fachbegriffe: Antisemitismus, Holocaust, Gleichschaltung, Propaganda',
            category: 'glossar',
            topics: ['nationalsozialismus', 'holocaust'],
            type: 'reference'
        },
        {
            id: 'k9-img-3',
            filename: 'IMG_2196.jpeg',
            title: 'Glossar Klasse 9 - Nachkriegszeit',
            description: 'Fachbegriffe: BRD, DDR, Kalter Krieg, Stasi, Wiedervereinigung',
            category: 'glossar',
            topics: ['brd-ddr', 'kalter-krieg', 'wiedervereinigung'],
            type: 'reference'
        },
        {
            id: 'k9-img-4',
            filename: 'IMG_2221.jpeg',
            title: 'Methodenverzeichnis - Quellenanalyse',
            description: 'Schritt-für-Schritt Anleitung zur Analyse historischer Quellen',
            category: 'methoden',
            topics: ['methoden', 'quellenanalyse'],
            type: 'method'
        },
        {
            id: 'k9-img-5',
            filename: 'IMG_2222.jpeg',
            title: 'Methodenverzeichnis - Bildanalyse',
            description: 'Anleitung zur Analyse von Propagandaplakaten und Fotografien',
            category: 'methoden',
            topics: ['methoden', 'bildanalyse'],
            type: 'method'
        },
        {
            id: 'k9-img-6',
            filename: 'IMG_2223.jpeg',
            title: 'Methodenverzeichnis - Textanalyse',
            description: 'Methoden zur Analyse von Sachtexten und Reden',
            category: 'methoden',
            topics: ['methoden', 'textanalyse'],
            type: 'method'
        }
    ],
    klasse10_1: [
        {
            id: 'k10-1-img-1',
            filename: 'IMG_2953.jpeg',
            title: 'Glossar Klasse 10 - Russland',
            description: 'Fachbegriffe: Bolschewiki, Sowjetunion, Glasnost, Perestroika',
            category: 'glossar',
            topics: ['russland', 'sowjetunion'],
            type: 'reference'
        },
        {
            id: 'k10-1-img-2',
            filename: 'IMG_2954.jpeg',
            title: 'Glossar Klasse 10 - China',
            description: 'Fachbegriffe: Opiumkriege, Maoismus, Kulturrevolution, Ein-Kind-Politik',
            category: 'glossar',
            topics: ['china'],
            type: 'reference'
        },
        {
            ...
            title: 'Glossar Klasse 10 - Osmanisches Reich/Türkei',
            description: 'Fachbegriffe: Völkermord, Laizismus, Kemalismus, Atatürk',
            category: 'glossar',
            topics: ['tuerkei', 'osmanisches-reich'],
            type: 'reference'
        },
        {
            id: 'k10-1-img-4',
            filename: 'IMG_2956.jpeg',
            title: 'Geschichtslexikon A-G',
            description: 'Umfassendes Lexikon historischer Begriffe von A bis G',
            category: 'glossar',
            topics: ['allgemein'],
            type: 'reference'
        },
        {
            id: 'k10-1-img-5',
            filename: 'IMG_2957.jpeg',
            title: 'Geschichtslexikon H-N',
            description: 'Umfassendes Lexikon historischer Begriffe von H bis N',
            category: 'glossar',
            topics: ['allgemein'],
            type: 'reference'
        },
        {
            id: 'k10-1-img-6',
            filename: 'IMG_2958.jpeg',
            title: 'Geschichtslexikon O-Z',
            description: 'Umfassendes Lexikon historischer Begriffe von O bis Z',
            category: 'glossar',
            topics: ['allgemein'],
            type: 'reference'
        },
        {
            id: 'k10-1-img-7',
            filename: 'IMG_2959.jpeg',
            title: 'Europäische Integration - Zeitleiste',
            description: 'Von der Montanunion zur Europäischen Union',
            category: 'zeitleiste',
            topics: ['europaeische-union'],
            type: 'timeline'
        }
    ],
    klasse10_2: [
        {
            ...
            title: 'Bildquellenverzeichnis - 20. Jahrhundert Teil 1',
            description: 'Fotografien und Dokumente aus der ersten Hälfte des 20. Jahrhunderts',
            category: 'quellen',
            topics: ['zeitgeschichte'],
            type: 'source'
        },
        {
            id: 'k10-2-img-2',
            filename: 'IMG_2961.jpeg',
            title: 'Bildquellenverzeichnis - 20. Jahrhundert Teil 2',
            description: 'Fotografien der Weltkriege und Zwischenkriegszeit',
            category: 'quellen',
            topics: ['zeitgeschichte'],
            type: 'source'
        },
        {
            id: 'k10-2-img-3',
            filename: 'IMG_2962.jpeg',
            title: 'Bildquellenverzeichnis - Kalter Krieg',
            description: 'Bildmaterial zum Ost-West-Konflikt',
            category: 'quellen',
            topics: ['kalter-krieg'],
            type: 'source'
        },
        {
            id: 'k10-2-img-4',
            filename: 'IMG_2963.jpeg',
            title: 'Bildquellenverzeichnis - Russland',
            description: 'Historische Fotografien aus der Sowjetunion',
            category: 'quellen',
            topics: ['russland', 'sowjetunion'],
            type: 'source'
        },
        {
            id: 'k10-2-img-5',
            filename: 'IMG_2964.jpeg',
            title: 'Bildquellenverzeichnis - China',
            description: 'Bildmaterial zur chinesischen Geschichte',
            category: 'quellen',
            topics: ['china'],
            type: 'source'
        },
        {
            id: 'k10-2-img-6',
            filename: 'IMG_2965.jpeg',
            title: 'Bildquellenverzeichnis - Türkei',
            description: 'Fotografien zur türkischen Geschichte',
            category: 'quellen',
            topics: ['tuerkei'],
            type: 'source'
        },
        {
            id: 'k10-2-img-7',
            filename: 'IMG_2966.jpeg',
            title: 'Bildquellenverzeichnis - Europa',
            description: 'Bildmaterial zur europäischen Integration',
            category: 'quellen',
            topics: ['europaeische-union'],
            type: 'source'
        }
